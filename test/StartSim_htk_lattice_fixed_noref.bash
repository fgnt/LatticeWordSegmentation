#!/bin/bash
##############################################################################################################################
### Call: StartSim_htk_lattice_fixed_noref.bash FileListPath KnownN UnkN NumIter AmScale PruneFactor                        ##
### e.g.: ./StartSim_htk_lattice_fixed_noref.bash WSJCAM0_WSJ0+1_Cross_Lattice/WSJCAM0_Phoneme_Lattice.htk.txt 1 2 200 1 16 ##
###                                                                                                                         ##
