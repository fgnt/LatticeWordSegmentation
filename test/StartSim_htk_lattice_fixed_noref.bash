#!/bin/bash
###########################################################################################################################
### Call: StartSim_htk_lattice_fixed_noref.bash FileListPath KnownN UnkN NumIter AmScale                                 ##
### e.g.: ./StartSim_htk_lattice_fixed_noref.bash WSJCAM0_WSJ0+1_Cross_Lattice/WSJCAM0_Phoneme_Lattice.htk.txt 1 2 200 1 ##
###                                                                                                                      ##
### Note this scipt mainly demonstrates the lattice export, NumIter should  be set to 0 when calling.                    ##
