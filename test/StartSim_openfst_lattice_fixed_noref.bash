#!/bin/bash
#################################################################################################################
### Call: StartSim_openfst_lattice_fixed_noref.bash FileListPath KnownN UnkN NumIter AmScale                   ##
### e.g.: ./StartSim_openfst_lattice_fixed_noref.bash WSJCAM0_Lattice/WSJCAM0_Phoneme_Lattice.10.txt 1 2 200 1 ##
###                                                                                                            ##
...
### correction factors is not done. No reference is used and therefore no evaluation is done                   ##
###                                                                                                            ##
### Segmentation results are saved in Results/${Path}_fixed_noref/${FileList}.                                 ##
###                                                                                                            ##
