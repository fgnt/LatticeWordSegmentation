#!/bin/bash
#####################################################################################################################################################################
### Call: StartSim_openfst_lattice_increase_fixed.bash FileListPath KnownN UnkN AddCharN NumIter AmScale SwitchIterIdx NewKnownN NewUnkN NewAddCharN NewLMNumIters ##
### e.g.: ./StartSim_openfst_lattice_increase_fixed.bash WSJCAM0_Lattice/WSJCAM0_Phoneme_Lattice.10.txt 1 2 4 200 1 35 2 6 8 0                                     ##
###                                                                                                                                                                ##
...
### sampling.Estimation of the word length distribution and correction factors is not done                                                                         ##
###                                                                                                                                                                ##
