#!/bin/bash
##########################################################################################################################################
### Call: StartSim_openfst_lattice_increase.bash FileListPath KnownN UnkN NumIter AmScale SwitchIterIdx NewKnownN NewUnkN NewLMNumIters ##
### e.g.: ./StartSim_openfst_lattice_increase.bash WSJCAM0_Lattice/WSJCAM0_Phoneme_Lattice.10.txt 1 2 200 1 35 2 6 0                    ##
###                                                                                                                                     ##
...
### word length distribution and correction factors is also done (Poisson distribution)                                                 ##
###                                                                                                                                     ##
