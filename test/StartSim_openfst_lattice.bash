#!/bin/bash
#####################################################################################################
### Call: StartSim_openfst_lattice.bash FileListPath KnownN UnkN NumIter AmScale                   ##
### e.g.: ./StartSim_openfst_lattice.bash WSJCAM0_Lattice/WSJCAM0_Phoneme_Lattice.10.txt 1 2 200 1 ##
###                                                                                                ##
...
### correction factors is also done (Poisson distribution)                                         ##
###                                                                                                ##
