#!/bin/bash
####################################################################################################################
### Call: StartSim_htk_lattice_export_noref.bash FileListPath PruneFactor                                          ##
### e.g.: ./StartSim_htk_lattice_export_noref.bash WSJCAM0_WSJ0+1_Cross_Lattice/WSJCAM0_Phoneme_Lattice.htk.txt 16 ##
###                                                                                                                ##
