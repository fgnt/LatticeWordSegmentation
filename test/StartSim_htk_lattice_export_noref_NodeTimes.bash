#!/bin/bash
###############################################################################################################################
### Call: StartSim_htk_lattice_export_noref_NodeTimes.bash FileListPath PruneFactor                                          ##
### e.g.: ./StartSim_htk_lattice_export_noref_NodeTimes.bash WSJCAM0_WSJ0+1_Cross_Lattice/WSJCAM0_Phoneme_Lattice.htk.txt 16 ##
###                                                                                                                          ##
### Note this scipt mainly demonstrates the lattice export.                                                                  ##
...
PostFix='_htk_export_noref_NodeTimes'
