#!/bin/bash
##################################################################################################################################
### Call: StartSim_htk_lattice_fixed_NodeTimes.bash FileListPath KnownN UnkN NumIter AmScale PruningFactor                      ##
### e.g.: ./StartSim_htk_lattice_fixed_NodeTimes.bash WSJCAM0_WSJ0+1_Cross_Lattice/WSJCAM0_Phoneme_Lattice.htk.txt 1 2 200 1 16 ##
###                                                                                                                             ##
### Note this scipt mainly demonstrates the LPER calculationa and processing from HTK slf lattices.                             ##
...
### correction factors is not done. The htk lattice are pruned with the given pruning factor and the                            ##
### phoneme error rate (PER) is claculated for the given pruning factor                                                         ##
###                                                                                                                             ##
